...
void init()
{
	...
	submarine->loadModel("TestModels/submarine.obj", myShader,4);
	...
	for (int i = 0; i < COLL_OBJ_COUNT; i++) {
		...
		if (i == 0) bag->loadStaticModel(myShader);
	...
	//rock2->loadModel("TestModels/box001.obj", myShader,5);
	//rock3->loadModel("TestModels/scenario.obj", myShader);
	//rock4->loadModel("TestModels/bag.obj", myShader);
	//rock5->loadModel("TestModels/box5.obj", myShader);
	submarine->setPos(0,-5.5,-342);
	submarine->updateTransform(0, 180, 0);
	cam.setCamRot(180);
	//rock4->setPos(20, 0, -20);
	//allActors.push_back(rock);
	//allActors.push_back(rock2);
	//allActors.push_back(rock3);
	//allActors.push_back(rock4);
	//allActors.push_back(rock5);

	//cout << " loading model " << endl;
	//if(objLoader.loadModel("TestModels/submarine.obj", model))//returns true if the model is loaded, puts the model in the model parameter
	//{
...
void update()
{
	cout << "Collectables: " << Collectable::totalCollected << endl;
